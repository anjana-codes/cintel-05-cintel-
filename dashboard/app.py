...
def reactive_calc_combined():
    ...
    temp = round(random.uniform(70, 73), 1)
...
ui.page_opts(title="Weather Express: Live Data Example", fillable=True)
...
with ui.sidebar(position="right", open="open"):
    ...
    ui.h6("Links:")
    ui.a(
         "Anjana's GitHub Source",
        href="https://github.com/anjana-codes/cintel-05-cintel-",
        target="_blank",
    )
    ui.a(
        "PyShiny Learn",
